...
import la.gov.nit.nitn.it_tips;
...
public class WPPostDetails extends AppCompatActivity {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        Log.e("WpPostDetails ", "  title is " + it_tips.mListPost.get(position).getTitle().getRendered());

        webView.getSettings().setJavaScriptEnabled(true);
        webView.loadUrl(it_tips.mListPost.get(position).getLink());
